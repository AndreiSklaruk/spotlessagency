    ...
    Route::prefix('project')->group(function () {
        ...
        Route::get('/bedroom/', function () {
            return view('pages.portfolio.bedroom.bedroom')
                ...
                ->with('fullImageUrl', asset('images/portfolio/modern-house/Spotlessagency_bedroom_staged_01.jpg'));
        });

        Route::get('/building/', function () {
            return view('pages.portfolio.building.building')
                ->with('backgroundImageUrl', asset('images/portfolio/fin777777-935x1024.jpg'))
                ->with('fullImageUrl', asset('images/portfolio/modern-house/Catalog_renderings_6.jpg'));
        });

        Route::get('/country-house/', function () {
            return view('pages.portfolio.country-house.country-house')
        ...
        Route::get('/dining-room/', function () {
            return view('pages.portfolio.dining-room.dining-room')
                ->with('backgroundImageUrl', asset('images/portfolio/Paige_200E_89th_Living_Dining_room_1_staged_AN.jpg'))
                ->with('fullImageUrl', asset('images/portfolio/dining-room/Paige_200E_89th_Living_Dining_room_1_staged_AN.jpg'));
        });
        ...
        Route::get('/living-room/', function () {
            return view('pages.portfolio.living-room.living-room')
        ...
        Route::get('/new-kitchen/', function () {
            return view('pages.portfolio.new-kitchen.new-kitchen')
        ...
        Route::get('/new-living-room/', function () {
            return view('pages.portfolio.new-living-room.new-living-room')
        ...
        Route::get('/our-living-room/', function () {
            return view('pages.portfolio.our-living-room.our-living-room')
        ...
        Route::get('/exterior-building/', function () {
            return view('pages.portfolio.exterior-building.exterior-building')
                ->with('backgroundImageUrl', asset('images/portfolio/Exterior-shot-614x1024-1.jpg'))
                ->with('fullImageUrl', asset('images/portfolio/exterior-building/Exterior-shot.jpg'));
        });
