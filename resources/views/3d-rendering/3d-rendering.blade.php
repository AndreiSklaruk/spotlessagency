...
@section('content')
    <div class="vc_row wpb_row vc_row-fluid">
        ...
        <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-6 vc_col-md-9 vc_col-xs-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
        ...
        <div class="wpb_column vc_column_container vc_col-sm-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    ...
                    <div class="norebro-gallery-sc gallery-wrap aos-init" id="norebro-custom-5e890b3d2d3db"
                ...
                <div class="wpb_wrapper">
                    <div class="norebro-text-sc " id="norebro-custom-5e890b3d2f346">
                        ...
                        <p><span style="font-weight: 400;">The rendering process starts with the creation of a 3D model consisting of multiple geometric shapes connected between each other in 3D space. Known as polygons these shapes constitute a model that is an ordinary wire-frame object. The next step is to provide these shapes with a real form and then give every model some aesthetic features and make it true to life. It requires from designers to know different </span><span
                                style="font-weight: 400;">3d rendering software</span><span style="font-weight: 400;"> at the professional level to get the most out of the existing technology.</span>
                        </p>
    ...
    <div class="vc_row wpb_row vc_row-fluid">
        <div class="wpb_column vc_column_container vc_col-sm-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="vc_empty_space" style="height: 40px"><span class="vc_empty_space_inner"></span></div>
                    <div class="norebro-gallery-sc gallery-wrap aos-init" id="norebro-custom-5e890b3d34e8f"
            ...
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="norebro-text-sc " id="norebro-custom-5e890b3d35e0c">
                        ...
                        <p><span style="font-weight: 400;">The demand for quality </span><span
                                style="font-weight: 400;">3D rendering services</span><span style="font-weight: 400;"> is constantly growing. It happens next to the increasing number of tools, software, technological devices appearing and soon it will become an indispensable part of many industries.</span>
                        </p>
    ...
    <div
        ...
        <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-6 vc_col-md-6 vc_col-xs-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="norebro-heading-sc heading text-center" id="norebro-custom-5e890b3d36a9e">
        ...
        <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-lg-6 vc_col-md-6 vc_col-xs-12">
            <div class="vc_column-inner ">
                <div class="wpb_wrapper">
                    <div class="norebro-heading-sc heading text-center" id="norebro-custom-5e890b3d3789a">
