...
<head>
    ...
    <title>Virtual Staging | Sell Properties Faster With Spotless Agency</title>
...
<body
    class="home page-template-default page page-id-13189 norebro-theme-1-0-0 wpb-js-composer js-comp-ver-5.4.7 vc_responsive"
    ...
    <div id="content" class="site-content" style="margin-bottom: 477px; position: relative; z-index: 3;">
                        ...
                        <article id="post-13189" class="post-13189 page type-page status-publish hentry">
                            <div class="entry-content">
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                     ...
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px;">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-has-fill">
                                        <div class="vc_column-inner vc_custom_1523354222386"
                                             style="padding-left: 303.5px;">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space  vc_hidden-xs" style="height: 90px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div class="vc_empty_space" style="height: 90px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-heading-sc heading nor-heading-xs text-left"
                                                     id="norebro-custom-5e75fd3f5a2f5">


                                                    <h1 class="title">
                                                        Virtual Staging<br class="vc_hidden-xs"></h1>


                                                    <p class="subtitle">
                                                        Demonstrate the property everyone desires and do it with virtual
                                                        home staging services we proudly offer in Spotless Agency!
                                                        Virtually staged homes look better than empty lifeless
                                                        apartments and if your work is selling properties you can
                                                        benefit a lot from staging. </p>
                                                ...
                                                <div class="norebro-button-sc btn-wrap text-left"
                                                    ...
                                                    <a href="https://www.spotlessagency.com/pricing/" target="_blank"
		...
		<span class="text">
			Get Started		</span>
                                    ...
                                    <div
                                        class="nor-top-layer nor-slider-wrap wpb_animate_when_almost_visible wpb_fadeIn fadeIn wpb_column vc_column_container vc_col-sm-6 wpb_start_animation animated">
                                        <div class="vc_column-inner vc_custom_1524646374441">
                                            <div class="wpb_wrapper">
                                                            ...
                                                            <div class="twentytwenty-container twentytwenty-custom"
                                                                ...
                                                                <div class="twentytwenty-overlay">
                                                                    <div class="twentytwenty-before-label"
                                                                         data-content="Before"></div>
                                                                    <div class="twentytwenty-after-label"
                                                                         data-content="After"></div>
                                                                </div>
                                                                <div class="twentytwenty-handle" style="left: 212.5px;">
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                     class="vc_row wpb_row vc_row-fluid vc_custom_1523352460435 vc_row-has-fill"
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px; padding-left: 288.5px; padding-right: 288.5px;">
                                    <div class="vc-bg-lines dark">
                                        <div></div>
                                        <div></div>
                                        <div></div>
                                    ...
                                    <div
                                        class="nrb-recent-projects wpb_column vc_column_container vc_col-sm-6 vc_hidden-md vc_hidden-sm vc_hidden-xs">
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="norebro-heading-sc heading text-center"
                                                     id="norebro-custom-5e75fd3f6036a">


                                                    <h2 class="title">
                                                        Spotless Agency is a leading virtual staging company </h2>


                                                    <p class="subtitle">
                                                        We help to open and show the home potential. Prove everyone that
                                                        your home is like a canvas that can become a masterpiece in the
                                                        hands of a talented artist. </p>
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-heading-sc heading text-center"
                                                     id="norebro-custom-5e75fd3f61b27">
                                                    ...
                                                    <p class="subtitle">
                                                        is a very popular direction in interior design and real estate
                                                        business as it allows people to see how a house, flat or office
                                                        will look like if you adorn it with furniture, accessories and
                                                        decor. Virtual staging is capable of providing the room not only
                                                        with furniture but also mood and exclusive atmosphere. It means
                                                        that talented specialists working for Spotless Agency will make
                                                        everyone love the virtually staged property at first sight at
                                                        it. </p>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-heading-sc heading text-center"
                                                     id="norebro-custom-5e75fd3f6258f">
                                                    ...
                                                    <p class="subtitle">
                                                        is a highly popular marketing tool in real estate business.
                                                        According to the statistical data from NAR, 94% of realtors
                                                        confirm the unmatched benefit brought by virtual staging: it can
                                                        not only increase the interest of people to the certain property
                                                        but also decrease the amount of time it spends in the market
                                                        almost by 50%. It is especially important for luxury properties
                                                        that are sold faster and even for bigger money thanks to
                                                        professional virtual staging services. </p>
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="vc_empty_space" style="height: 60px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-heading-sc heading text-center aos-init"
                                                     id="norebro-custom-5e75fd3f63b2b" data-aos="fade-up">
                                ...
                                <div class="vc_row-full-width vc_clearfix"></div>
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                     class="vc_row wpb_row vc_row-fluid how-it-work-row wpb_animate_when_almost_visible wpb_fadeInUp fadeInUp vc_row-o-equal-height vc_row-o-content-middle vc_row-flex"
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px; padding-left: 288.5px; padding-right: 288.5px;">
                                    <div class="vc-bg-lines dark">
                                        <div></div>
                                        <div></div>
                                    ...
                                    <div class="texture-bg-right wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524661934806">
                                            <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524660928293">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-process-sc process "
                                                     id="norebro-custom-5e75fd3f68c0b">
                                                ...
                                                <div class="norebro-text-sc " id="norebro-custom-5e75fd3f69c14">

                                                    <p>Send photographs of the rooms of the biggest size you have in
                                                        JPEG format. To get the result of the highest quality we advise
                                                        realtors to use services of the professional photographers.</p>
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524661839460">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-process-sc process "
                                                     id="norebro-custom-5e75fd3f6c095">

                                                    <div class="number">02.</div>
                                                    <h3>Choose the interior design style</h3>
                                                    <p class="description"></p>

                                                </div>
                                                <div class="norebro-text-sc " id="norebro-custom-5e75fd3f6c64e">

                                                    <p>Pick 2 or 3 interior photos (you can use google search, pinterest
                                                        or other sources) that you like, and send them to us. It will
                                                        help our artists to understand the design style you want to get,
                                                        when your virtually staged photo is finished.</p>

                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="texture-bg-left wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524662092168">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_single_image wpb_content_element vc_align_center">
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                    ...
                                    <div class="texture-bg-right wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524662557786">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_single_image wpb_content_element vc_align_center">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524660928293">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-process-sc process "
                                                     id="norebro-custom-5e75fd3f74e3f">

                                                    <div class="number">03.</div>
                                                    <h3>Provide a floor plan</h3>
                                                    <p class="description"></p>

                                                </div>
                                                <div class="norebro-text-sc " id="norebro-custom-5e75fd3f753b7">

                                                    <p>Floor plans allow us to understand the right scale of your
                                                        property and get better results. However, if you don’t have a
                                                        floor plan, we can perform virtual home staging without it.</p>
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                        <div class="vc_column-inner vc_custom_1524661839460">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-process-sc process "
                                                     id="norebro-custom-5e75fd3f77b3a">
                                                ...
                                                <div class="norebro-text-sc " id="norebro-custom-5e75fd3f780e6">

                                                    <p>After receiving all the necessary information mentioned above,
                                                        our assistant will <a
                                                            href="https://www.spotlessagency.com/contact/">contact</a>
                                                        you to discuss all the details.</p>
                                                    ...
                                                    <figure class="wpb_wrapper vc_figure">
                                                        <div class="vc_single_image-wrapper   vc_box_border_grey">
                                                            <img
                                                                class="vc_single_image-img "
                                                                src="./images/form.png"
                                                                width="648" height="288" alt="form" title="form">
                                                        </div>
                                                    </figure>
                                                </div>
                                            </div>
                                ...
                                <div class="vc_row-full-width vc_clearfix"></div>
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                     class="vc_row wpb_row vc_row-fluid nor-top-layer vc_custom_1528372720244 vc_row-has-fill"
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px; padding-left: 288.5px; padding-right: 288.5px;">
                                    <div class="vc-bg-lines dark">
                                        <div></div>
                                        <div></div>
                                                ...
                                                <div data-norebro-portfolio-grid="true"
                                                    ...
                                                    <div class="portfolio-sorting text-left" data-filter="portfolio">
                                                        <ul class="unstyled">
                                                            <li>
                                                                <a class="active"
                                                                   href="https://www.spotlessagency.com/#all"
                                                                   data-isotope-filter="*">
                                                            ...
                                                            <li>
                                                                <a href="https://www.spotlessagency.com/#virtual-staging"
                                                                   data-isotope-filter=".norebro-filter-project-a0664e1559e10ca00131e05eff284917">
                                                                    <span class="name">Virtual Staging</span>
                                                                    <span class="num">06</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="vc_row  with-sorting" data-isotope-grid="true"
                                                        ...
                                                        <div
                                                            ...
                                                            <div data-aos-once="true" data-aos="fade-up"
                                                                 data-aos-delay="0" class="aos-init">
                                                        ...
                                                        <div
                                                            class="portfolio-item-wrap masonry-block grid-item vc_col-lg-4 norebro-project-item norebro-filter-project-a0664e1559e10ca00131e05eff284917"
                                                            data-lazy-item="true"
                                                            style="position: absolute; left: 442px; top: 0px;">
                                                            <div data-aos-once="true" data-aos="fade-up"
                                                                 data-aos-delay="100" class="aos-init">
                                                                <div class="portfolio-item grid-1">
                                                        ...
                                                        <div
                                                            class="portfolio-item-wrap masonry-block grid-item vc_col-lg-4 norebro-project-item norebro-filter-project-a0664e1559e10ca00131e05eff284917"
                                                            data-lazy-item="true"
                                                            style="position: absolute; left: 884px; top: 0px;">
                                                            <div data-aos-once="true" data-aos="fade-up"
                                                                 data-aos-delay="250" class="aos-init">
                                                                <div class="portfolio-item grid-1">
                                                        ...
                                                        <div
                                                            class="portfolio-item-wrap masonry-block grid-item vc_col-lg-4 norebro-project-item norebro-filter-project-a0664e1559e10ca00131e05eff284917"
                                                            data-lazy-item="true"
                                                            style="position: absolute; left: 884px; top: 305px;">
                                                            <div data-aos-once="true" data-aos="fade-up"
                                                                 data-aos-delay="100" class="aos-init">
                                                                <div class="portfolio-item grid-1">
                                                        ...
                                                        <div
                                                            class="portfolio-item-wrap masonry-block grid-item vc_col-lg-4 norebro-project-item norebro-filter-project-a0664e1559e10ca00131e05eff284917"
                                                            data-lazy-item="true"
                                                            style="position: absolute; left: 442px; top: 306px;">
                                                            <div data-aos-once="true" data-aos="fade-up"
                                                                 data-aos-delay="250" class="aos-init">
                                                                <div class="portfolio-item grid-1">
                                ...
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space  norebro-phone-space" style="height: 200px">
                                                    <span class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-button-sc btn-wrap text-center"
                                                     id="norebro-custom-5e75fd3fe3785">

                                                    <a href="https://www.spotlessagency.com/virtual-staging-works/"
                                                       target="_blank" class="btn  btn-squared btn-outline btn-large">


		<span class="text">
			See More Examples		</span>
                                ...
                                <div class="vc_row-full-width vc_clearfix"></div>
                                <div data-vc-full-width="true" data-vc-full-width-init="true"
                                     class="vc_row wpb_row vc_row-fluid vc_custom_1530883197045 vc_row-has-fill"
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px; padding-left: 288.5px; padding-right: 288.5px;">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space  norebro-phone-space" style="height: 40px">
                                                    <span class="vc_empty_space_inner"></span></div>
                                                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-heading-sc heading text-center aos-init"
                                                                    id="norebro-custom-5e75fd3fedad4"
                                                                    data-aos="fade-up">
                                                ...
                                                <div class="vc_empty_space  norebro-phone-space" style="height: 20px">
                                                    <span class="vc_empty_space_inner"></span></div>
                                                <div
                                                    class="vc_row wpb_row vc_inner vc_row-fluid text-left vc_row-o-equal-height vc_row-o-content-middle vc_row-flex">
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3">
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default text-left"
                                                                    id="norebro-custom-5e75fd3fefd2a">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default text-left"
                                                                    id="norebro-custom-5e75fd3ff15f3">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default text-left"
                                                                    id="norebro-custom-5e75fd3ff25ce">
                                                    ...
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3 vc_col-has-fill">
                                                        <div class="vc_column-inner vc_custom_1530883573782">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default"
                                                                    id="norebro-custom-5e75fd3ff36a3">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3 vc_col-has-fill">
                                                        <div class="vc_column-inner vc_custom_1530883578165">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default"
                                                                    id="norebro-custom-5e75fd4000c1d">
                                                    ...
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3 vc_col-has-fill">
                                                        <div class="vc_column-inner vc_custom_1530883581951">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default"
                                                                    id="norebro-custom-5e75fd4001d2a">
                                                    ...
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3 vc_col-has-fill">
                                                        <div class="vc_column-inner vc_custom_1530883585315">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default"
                                                                    id="norebro-custom-5e75fd4002dec">
                                                    ...
                                                    <div
                                                        class="client-img-padding wpb_column vc_column_container vc_col-sm-3 vc_col-has-fill">
                                                        <div class="vc_column-inner vc_custom_1530883588966">
                                                            <div class="wpb_wrapper">
                                                                <div
                                                                    class="norebro-client-logo-sc clients-logo text-center default"
                                                                    id="norebro-custom-5e75fd4003e1a">
                                                ...
                                                <div class="vc_empty_space  norebro-phone-space" style="height: 50px">
                                                    <span class="vc_empty_space_inner"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space  norebro-phone-space" style="height: 30px">
                                                    <span class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-heading-sc heading text-center aos-init"
                                                     id="norebro-custom-5e75fd4005911" data-aos="fade-up">
                                                ...
                                                <div class="norebro-slider-sc slider-wrap">
                                                    <div
                                                        class="slider norebro-slider  full with-dots owl-loaded owl-drag"
		...
		<span class="text">
			All reviews		</span>
                                ...
                                <div class="vc_row-full-width vc_clearfix"></div>
                                <div id="orderProject" data-vc-full-width="true" data-vc-full-width-init="true"
                                     data-vc-stretch-content="true"
                                     class="vc_row wpb_row vc_row-fluid norebro-content-wrap-left padding-reset-left padding-reset-right vc_custom_1523349939762 vc_row-has-fill vc_row-no-padding vc_row-o-equal-height vc_row-flex"
                                     style="position: relative; left: -288.5px; box-sizing: border-box; width: 1903px;">
                                    <div class="wpb_column vc_column_container vc_col-sm-8">
                                        <div class="vc_column-inner vc_custom_1508401560329"
                                             style="padding-left: 303.5px;">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-heading-sc heading text-left aos-init"
                                                     id="norebro-custom-5e75fd40106a6" data-aos="fade-up">
                                                ...
                                                <div class="vc_empty_space" style="height: 15px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div
                                                    class="norebro-contact-from-sc contact-form  text-left form-btn-custom"
                                                    id="norebro-custom-5e75fd4010b00">

                                                    <div role="form" class="wpcf7" id="wpcf7-f13235-p13189-o7"
                                                         lang="ru-RU" dir="ltr">
                                                        <div class="screen-reader-response"></div>
                                                        <form
                                                            action="https://www.spotlessagency.com/#wpcf7-f13235-p13189-o7"
                                                            ...
                                                            <div style="display: none;">
                                                                ...
                                                                <input type="hidden" name="_wpcf7cf_options"
                                                                       value="{&quot;form_id&quot;:13235,&quot;conditions&quot;:[{&quot;if_field&quot;:&quot;menu-342&quot;,&quot;operator&quot;:&quot;equals&quot;,&quot;if_value&quot;:&quot;Virtual staging services&quot;,&quot;then_field&quot;:&quot;Pricing&quot;}],&quot;settings&quot;:false}">
                                                            </div>
                                                            <div class="input-group">
                                                                ...
                                                                <label class="col-4">
                                                                    <div id="Pricing" data-class="wpcf7cf_group"
                                                                         class="wpcf7cf-hidden"><span
                                                                            class="wpcf7-form-control-wrap menu-674"><select
                                                                                name="menu-674"
                                                                                class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required"
                                                                                aria-required="true"
                                                                                aria-invalid="false"><option
                                                                                    value="Pricing">Pricing</option><option
                                                                                    value="Light">Light</option><option
                                                                                    value="Standard">Standard</option><option
                                                                                    value="Professional">Professional</option></select></span>
                                                                    </div>
                                                                    <p>
                                                                    </p></label></div>
                                                            <div class="input-group">
				...
				<textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response"
                          style="width: 250px; height: 40px; border: 1px solid #c1c1c1; margin: 10px 25px; padding: 0px; resize: none;">
                                                            ...
                                                            <p>
                                                                <button class="btn  btn-squared btn-outline">
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper" style="height: 100%;">
                                                <div class="norebro-google-maps-sc google-maps"
                                                     id="norebro-custom-5e75fd4016d9a" data-google-map="true"
                                                     data-google-map-zoom="10" data-google-map-zoom-enable=""
                                                     data-google-map-marker="" data-google-map-style="flat_pale">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    style="position: absolute; z-index: 990; transform: matrix(1, 0, 0, 1, -227, -147);">
                                                                                    <div
                                                                                        style="position: absolute; left: 0px; top: 0px; width: 256px; height: 256px;">
                                                                                        <div
                                                                                            style="width: 256px; height: 256px;"></div>
                                                                                    </div>
                                                                                    <div
...
{{--                                                                        src="./Virtual Staging _ Sell Properties Faster With Spotless Agency_files/saved_resource(4).html"></iframe>--}}
                                                                <div
                                                                    ...
                                                                    <a target="_blank" rel="noopener"
                                                                       href="https://maps.google.com/maps?ll=39.755059,-75.626366&amp;z=10&amp;t=m&amp;hl=ru-RU&amp;gl=US&amp;mapclient=apiv3"
                                                                ...
                                                                <div
                                                                    style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 16px; z-index: 10000002; display: none; width: 300px; height: 180px; position: absolute; left: 167px; top: 222px;">
                                                                    <div
                                                                        style="padding: 0px 0px 10px; font-size: 16px; box-sizing: border-box;">
                                                                        Картографические данные
                                                                    </div>
                                                                    <div style="font-size: 13px;">Картографические
                                                                        данные © 2020 Google
                                                                    </div>
                                                                    <button draggable="false" title="Закрыть"
                                                                ...
                                                                <div class="gmnoprint"
                                                                     style="z-index: 1000001; position: absolute; right: 279px; bottom: 0px; width: 208px;">
                                                                    <div draggable="false" class="gm-style-cc"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a style="text-decoration: none; cursor: pointer; display: none;">Картографические
                                                                                данные</a><span>Картографические данные © 2020 Google</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div draggable="false" class="gm-style-cc"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <a target="_blank" rel="noopener"
                                                                           ...
                                                                           href="https://www.google.com/maps/@39.7550593,-75.6263656,10z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="gmnoprint" controlwidth="40"
                                                                        ...
                                                                        <div draggable="false"
                                                                            ...
                                                                            <button draggable="false" title="Увеличить"
                                                                                    aria-label="Увеличить" type="button"
                                                                            ...
                                                                            <button draggable="false" title="Уменьшить"
                                                                                    aria-label="Уменьшить" type="button"
                                                                                    class="gm-control-active"
                                                                                    style="background: none; display: block; border: 0px; margin: 0px; padding: 0px; position: relative; cursor: pointer; user-select: none; overflow: hidden; width: 40px; height: 40px; top: 0px; left: 0px;">
                                                                                <img
                                                    ...
                                                    <div class="hidden" data-google-map-markers="true">2711 Centerville
                                                        Road Wilmington, DE, 19808, United States
                                                    </div>
...
{{--                src="./Virtual Staging _ Sell Properties Faster With Spotless Agency_files/bframe.html"--}}
{{--                name="c-tzfxjqprry6z" frameborder="0" scrolling="no"--}}
...
{{--        recaptcha --}}
{{--        <iframe title="проверка recaptcha"--}}
{{--                src="./Virtual Staging _ Sell Properties Faster With Spotless Agency_files/bframe(1).html"--}}
{{--                name="c-9atts4rih1ri" frameborder="0" scrolling="no"--}}
{{--                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"--}}
{{--                style="width: 100%; height: 100%;"></iframe>--}}
{{--    </div>--}}
{{--</div>--}}
...
{{--    <div style="z-index: 2000000000; position: relative;">--}}
{{--        <iframe title="проверка recaptcha"--}}
{{--                src="./Virtual Staging _ Sell Properties Faster With Spotless Agency_files/bframe(2).html"--}}
{{--                name="c-uyjitk7gdxrl" frameborder="0" scrolling="no"--}}
{{--                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"--}}
{{--                style="width: 100%; height: 100%;"></iframe>--}}
{{--    </div>--}}
{{--</div>--}}
...
{{--    <div style="z-index: 2000000000; position: relative;">--}}
{{--        <iframe title="проверка recaptcha"--}}
{{--                src="./Virtual Staging _ Sell Properties Faster With Spotless Agency_files/bframe(3).html"--}}
{{--                name="c-eczy2sqy8stp" frameborder="0" scrolling="no"--}}
{{--                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"--}}
{{--                style="width: 100%; height: 100%;"></iframe>--}}
{{--    </div>--}}
{{--</div>--}}
