<div class="norebro-contact-from-sc contact-form  text-left" id="norebro-custom-5e8b7bc2df1ed">
    <div role="form" class="wpcf7" id="wpcf7-f13235-p13148-o7"
         lang="ru-RU" dir="ltr">
        <div class="screen-reader-response"></div>
        <form action="#wpcf7-f13235-p13148-o7" method="post" class="wpcf7-form" novalidate="novalidate">
            ...
            <div class="input-group">
                <label class="col-12"><textarea name="your-message"
                                                cols="40" rows="10"
            ...
            <p>
                <button
                    class="btn  brand-bg-color-hover-i brand-border-color-hover-i btn-squared btn-large btn-outline btn-brand brand-color">
    ...
    <div class="hidden" data-contact-btn="true"></div>
</div>
