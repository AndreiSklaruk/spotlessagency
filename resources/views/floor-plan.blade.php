<!DOCTYPE html>
<!-- saved from url=(0055)https://www.spotlessagency.com/flor-plan-visualization/ -->
...
<head>
    ...
    <title>Spotless Agency introduces Floor Plan Visualization</title>
    <meta property="og:title" content="Floor Plan Visualization">
    <meta property="og:description" content="">
    <meta property="og:url" content="https://www.spotlessagency.com/flor-plan-visualization/">
    <meta name="twitter:card" content="summary">
    <meta property="twitter:title" content="Floor Plan Visualization">
    <meta property="twitter:description" content="">
    <meta name="author" content="Andrey Zlobin">

    <!-- All in One SEO Pack 2.6 by Michael Torbert of Semper Fi Web Design[300,355] -->
    ...
    <style id="norebro-style-inline-css" type="text/css">
        ...
        #fullscreen-mega-menu .copyright, .fullscreen-navigation #secondary-menu li a, .fullscreen-navigation #secondary-menu li:hover > a.menu-link, .fullscreen-navigation #secondary-menu li div.sub-nav a, .fullscreen-navigation #secondary-menu li .sub-sub-menu a {
            color: #373c40;
        }

        .fullscreen-navigation .ion-ios-close-empty {
            color: #373c40;
        }
        ...
        .countdown-box .box-time .box-count, .chart-box-pie-content {
            font-family: 'Poppins', sans-serif;
            font-weight: 500;
            color: #373c40;
        }
        ...
        input.classic::-webkit-input-placeholder, .contact-form.classic input::-webkit-input-placeholder, .contact-form.classic textarea::-webkit-input-placeholder, input.classic::-moz-placeholder {
            font-family: 'Poppins', sans-serif;
            font-size: 18px;
            color: #718091;
        }

        .contact-form.classic input::-moz-placeholder, .contact-form.classic textarea::-moz-placeholder {
            font-family: 'Poppins', sans-serif;
            font-size: 18px;
            color: #718091;
        }
        ...
        .video-module.btn-brand-color-hover:hover .btn-play .icon, .brand-color-i, .brand-color-after-i:after, .brand-color-before-i:before, .brand-color-hover-i:hover, .brand-color-hover-i-after:after, .brand-color-hover-i-before:before {
        ...
        .brand-border-color-i, .brand-border-color-after-i:after, .brand-border-color-before-i:before, .brand-border-color-hover-i:hover, .brand-border-color-hover-i-after:after, .brand-border-color-hover-i-before:before {
            border-color: #f3b435 !important;
        }
    ...
    <style id="popup-maker-site-inline-css" type="text/css">
        ...
        .pum-theme-15152, .pum-theme-framed-border {
            background-color: rgba(255, 255, 255, 0.50)
        }

        .pum-theme-15152 .pum-container, .pum-theme-framed-border .pum-container {
            padding: 18px;
            border-radius: 0px;
        ...
        .pum-theme-15152 .pum-title, .pum-theme-framed-border .pum-title {
            color: #000000;
            text-align: left;
        ...
        .pum-theme-15152 .pum-content, .pum-theme-framed-border .pum-content {
            color: #2d2d2d;
            font-family: inherit
        }

        .pum-theme-15152 .pum-content + .pum-close, .pum-theme-framed-border .pum-content + .pum-close {
            height: 20px;
            width: 20px;
            left: auto;
            right: -20px;
        ...
        .pum-theme-15151, .pum-theme-cutting-edge {
            background-color: rgba(0, 0, 0, 0.50)
        }

        .pum-theme-15151 .pum-container, .pum-theme-cutting-edge .pum-container {
            padding: 18px;
            border-radius: 0px;
        ...
        .pum-theme-15151 .pum-title, .pum-theme-cutting-edge .pum-title {
            color: #ffffff;
            text-align: left;
            text-shadow: 0px 0px 0px rgba(2, 2, 2, 0.23);
        ...
        .pum-theme-15151 .pum-content, .pum-theme-cutting-edge .pum-content {
            color: #ffffff;
            font-family: inherit
        }

        .pum-theme-15151 .pum-content + .pum-close, .pum-theme-cutting-edge .pum-content + .pum-close {
            height: 24px;
            width: 24px;
            left: auto;
            right: 0px;
        ...
        .pum-theme-15150, .pum-theme-hello-box {
            background-color: rgba(0, 0, 0, 0.75)
        }

        .pum-theme-15150 .pum-container, .pum-theme-hello-box .pum-container {
            padding: 16px;
            border-radius: 34px;
        ...
        .pum-theme-15150 .pum-title, .pum-theme-hello-box .pum-title {
            color: #000000;
            text-align: left;
            text-shadow: 0px 0px 0px rgba(2, 2, 2, 0.23);
        ...
        .pum-theme-15150 .pum-content, .pum-theme-hello-box .pum-content {
            color: #2d2d2d;
            font-family: inherit
        }

        .pum-theme-15150 .pum-content + .pum-close, .pum-theme-hello-box .pum-content + .pum-close {
            height: auto;
            width: auto;
            left: auto;
            right: -2px;
        ...
        .pum-theme-15149, .pum-theme-enterprise-blue {
            background-color: rgba(0, 0, 0, 0.70)
        }

        .pum-theme-15149 .pum-container, .pum-theme-enterprise-blue .pum-container {
            padding: 28px;
            border-radius: 5px;
            border: 1px none #000000;
        ...
        .pum-theme-15149 .pum-title, .pum-theme-enterprise-blue .pum-title {
            color: #315b7c;
            text-align: left;
            text-shadow: 0px 0px 0px rgba(2, 2, 2, 0.23);
            font-family: inherit;
        ...
        .pum-theme-15149 .pum-content, .pum-theme-enterprise-blue .pum-content {
            color: #2d2d2d;
            font-family: inherit
        }

        .pum-theme-15149 .pum-content + .pum-close, .pum-theme-enterprise-blue .pum-content + .pum-close {
            height: 28px;
            width: 28px;
            left: auto;
            right: 8px;
        ...
        .pum-theme-15148, .pum-theme-lightbox {
            background-color: rgba(0, 0, 0, 0.60)
        }

        .pum-theme-15148 .pum-container, .pum-theme-lightbox .pum-container {
            padding: 18px;
            border-radius: 0px;
            border: 0px solid #f9f9f9;
            box-shadow: 0px 0px 30px 0px rgba(249, 249, 249, 0.00);
            background-color: rgba(249, 249, 249, 1.00)
        }

        .pum-theme-15148 .pum-title, .pum-theme-lightbox .pum-title {
            color: #000000;
            text-align: left;
            text-shadow: 0px 0px 0px rgba(2, 2, 2, 0.23);
            font-family: inherit;
        ...
        .pum-theme-15148 .pum-content, .pum-theme-lightbox .pum-content {
            color: #000000;
            font-family: inherit
        }

        .pum-theme-15148 .pum-content + .pum-close, .pum-theme-lightbox .pum-content + .pum-close {
            height: 30px;
            width: 30px;
            left: auto;
            right: -24px;
        ...
        .pum-theme-15147, .pum-theme-default-theme {
            background-color: rgba(255, 255, 255, 1.00)
        }

        .pum-theme-15147 .pum-container, .pum-theme-default-theme .pum-container {
            padding: 18px;
            border-radius: 0px;
            border: 1px none #000000;
        ...
        .pum-theme-15147 .pum-title, .pum-theme-default-theme .pum-title {
            color: #000000;
            text-align: left;
            text-shadow: 0px 0px 0px rgba(2, 2, 2, 0.23);
            font-family: inherit;
        ...
        .pum-theme-15147 .pum-content, .pum-theme-default-theme .pum-content {
            color: #8c8c8c;
            font-family: inherit;
            font-weight: inherit;
            font-style: normal
        ...
        .pum-theme-15147 .pum-content + .pum-close, .pum-theme-default-theme .pum-content + .pum-close {
            height: auto;
            width: auto;
            left: auto;
            right: 0px;
    ...
    <link rel="shortlink" href="https://www.spotlessagency.com/?p=13278">
    <link rel="alternate" type="application/json+oembed"
          href="https://www.spotlessagency.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.spotlessagency.com%2Fflor-plan-visualization%2F">
    <link rel="alternate" type="text/xml+oembed"
          href="https://www.spotlessagency.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.spotlessagency.com%2Fflor-plan-visualization%2F&amp;format=xml">
    ...
    <script async=""
            src="./Spotless Agency introduces Floor Plan Visualization_files/hotjar-909309.js.Без названия"></script>

    <script async=""
            src="./Spotless Agency introduces Floor Plan Visualization_files/modules.0be5265654b49cdd90f7.js.Без названия"
...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header dark-text header-2 header-fixed showed" data-header-fixed="true"
        ...
        <div class="header-wrap page-container">
			...
			<span class="logo with-mobile" style="display: none;">
									<img src="./Spotless Agency introduces Floor Plan Visualization_files/logo_grey.png"
                                         srcset="https://www.spotlessagency.com/wp-content/uploads/2018/05/logo_grey.png 2x"
                                         alt="Spotless Agency">
							</span>

                        <span class="fixed-logo" style="display: inline;">
									<img src="./Spotless Agency introduces Floor Plan Visualization_files/logo_grey.png"
                                         srcset="https://www.spotlessagency.com/wp-content/uploads/2018/05/logo_grey.png 2x"
                                         alt="Spotless Agency">
							</span>
				...
				<img src="./Spotless Agency introduces Floor Plan Visualization_files/logo_grey.png" class=""
                     alt="Spotless Agency">
			</span>
				...
				<span class="dark hidden">
											<img
                                                src="./Spotless Agency introduces Floor Plan Visualization_files/logo_grey.png"
                                                srcset="https://www.spotlessagency.com/wp-content/uploads/2018/05/logo_grey.png 2x"
                                                alt="Spotless Agency">
									</span>
                ...
                <nav id="site-navigation" class="main-nav">
                    ...
                    <div id="mega-menu-wrap" role="navigation">
                        <ul id="primary-menu" class="menu">
                            <li id="nav-menu-item-13198-5e838c5f01636"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    ...
                                    id="accessible-megamenu-1585684882673-1"><span>Home</span></a></li>
                            <li id="nav-menu-item-13269-5e838c5f01991"
                                class="mega-menu-item nav-item menu-item-depth-0 current-menu-ancestor current-menu-parent has-submenu">
                                <a href="https://www.spotlessagency.com/flor-plan-visualization/#"
                                   class="menu-link main-menu-link item-title" id="accessible-megamenu-1585684882675-2"
                                   aria-haspopup="true" aria-owns="accessible-megamenu-1585684882675-3"
                                   aria-controls="accessible-megamenu-1585684882675-3" aria-expanded="false"><span>What do we do</span></a>
                                <div class="sub-nav" id="accessible-megamenu-1585684882675-3" role="group"
                                     aria-expanded="false" aria-hidden="true"
                                     aria-labelledby="accessible-megamenu-1585684882675-2">
                                    <ul class="menu-depth-1 sub-menu sub-nav-group">
                                        <li id="nav-menu-item-14394-5e838c5f01c83"
                                            class="mega-menu-item sub-nav-item menu-item-depth-1 current-menu-item "><a
                                        ...
                                        <li id="nav-menu-item-14393-5e838c5f01f65"
                                            ...
                                            <div class="sub-sub-nav">
                                                <ul class="menu-depth-2 sub-sub-menu">
                                                    <li id="nav-menu-item-14395-5e838c5f02233"
                                                    ...
                                                    <li id="nav-menu-item-13272-5e838c5f02515"
                                                        class="mega-menu-item sub-nav-item menu-item-depth-2 "><a
                            ...
                            <li id="nav-menu-item-13861-5e838c5f0286f"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    href="https://www.spotlessagency.com/pricing/"
                                    class="menu-link main-menu-link item-title"
                                    id="accessible-megamenu-1585684882676-4"><span>Pricing</span></a></li>
                            <li id="nav-menu-item-13195-5e838c5f02b9f"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    href="https://www.spotlessagency.com/virtual-staging-works/"
                                    class="menu-link main-menu-link item-title"
                                    id="accessible-megamenu-1585684882677-5"><span>Portfolio</span></a></li>
                            <li id="nav-menu-item-13194-5e838c5f02ee9"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    href="https://www.spotlessagency.com/blog/"
                                    class="menu-link main-menu-link item-title"
                                    id="accessible-megamenu-1585684882678-6"><span>Blog</span></a></li>
                            <li id="nav-menu-item-13259-5e838c5f03214"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    href="https://www.spotlessagency.com/about/"
                                    class="menu-link main-menu-link item-title"
                                    id="accessible-megamenu-1585684882681-7"><span>About</span></a></li>
                            <li id="nav-menu-item-13196-5e838c5f03562"
                                class="mega-menu-item nav-item menu-item-depth-0"><a
                                    href="https://www.spotlessagency.com/contact/"
                                    class="menu-link main-menu-link item-title"
                                    id="accessible-megamenu-1585684882681-8"><span>Contact</span></a></li>
                        </ul>
                    </div>
        ...
        <div class="fullscreen-menu-wrap">
            <div id="fullscreen-mega-menu-wrap" role="navigation">
                <ul id="secondary-menu" class="menu">
                    <li id="nav-menu-item-13198-5e838c5f0f985" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/" class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882685-10" role="group" aria-expanded="false"
                            aria-hidden="true"><span>Home</span></a></li>
                    <li id="nav-menu-item-13269-5e838c5f0fd07"
                        class="mega-menu-item nav-item menu-item-depth-0 current-menu-ancestor current-menu-parent has-submenu">
                        <a href="https://www.spotlessagency.com/flor-plan-visualization/#"
                           class="menu-link main-menu-link item-title"><span>What do we do</span></a>
                        <div class="sub-nav" id="accessible-megamenu-1585684882687-12" role="group"
                             aria-expanded="false" aria-hidden="true">
                            <ul class="menu-depth-1 sub-menu sub-nav-group">
                                <li id="nav-menu-item-14394-5e838c5f1009b"
                                    class="mega-menu-item sub-nav-item menu-item-depth-1 current-menu-item "><a
                                        href="https://www.spotlessagency.com/flor-plan-visualization/"
                                        class="menu-link sub-menu-link"><span>Floor Plan Visualization</span></a></li>
                                <li id="nav-menu-item-14393-5e838c5f103c0"
                                    class="mega-menu-item sub-nav-item menu-item-depth-1 has-submenu "><a
                                        href="https://www.spotlessagency.com/3d-renderings/"
                                        class="menu-link sub-menu-link"><span>3D Renderings</span></a>
                                    <div class="sub-sub-nav">
                                        <ul class="menu-depth-2 sub-sub-menu">
                                            <li id="nav-menu-item-14395-5e838c5f10752"
                                                class="mega-menu-item sub-nav-item menu-item-depth-2 "><a
                                                    href="https://www.spotlessagency.com/3d-renderings/architectural-visualization/"
                                                    class="menu-link sub-menu-link"><span>Architectural Visualization</span></a>
                                            </li>
                                            <li id="nav-menu-item-13272-5e838c5f10aaf"
                                                class="mega-menu-item sub-nav-item menu-item-depth-2 "><a
                                                    href="https://www.spotlessagency.com/3d-renderings/furniture-renderings/"
                                                    class="menu-link sub-menu-link"><span>Furniture Renderings</span></a>
                                            </li>
                    ...
                    <li id="nav-menu-item-13861-5e838c5f10eb5" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/pricing/"
                            class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882688-14" role="group" aria-expanded="false"
                            aria-hidden="true"><span>Pricing</span></a></li>
                    <li id="nav-menu-item-13195-5e838c5f1127e" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/virtual-staging-works/"
                            class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882689-16" role="group" aria-expanded="false"
                            aria-hidden="true"><span>Portfolio</span></a></li>
                    <li id="nav-menu-item-13194-5e838c5f11689" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/blog/"
                            class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882690-18" role="group" aria-expanded="false"
                            aria-hidden="true"><span>Blog</span></a></li>
                    <li id="nav-menu-item-13259-5e838c5f11a60" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/about/"
                            class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882691-20" role="group" aria-expanded="false"
                            aria-hidden="true"><span>About</span></a></li>
                    <li id="nav-menu-item-13196-5e838c5f11e5a" class="mega-menu-item nav-item menu-item-depth-0"><a
                            href="https://www.spotlessagency.com/contact/"
                            class="menu-link main-menu-link item-title sub-nav"
                            id="accessible-megamenu-1585684882692-22" role="group" aria-expanded="false"
                ...
                <div class="content">
                    ...
                    <div class="page-container">
                        <div class="wrap-container">
                            ...
                            <h1 class="page-title no-transition">Floor Plan Visualization</h1>
                        </div>
                    </div>
            ...
            <div id="primary" class="content-area">
                        ...
                        <article id="post-13278" class="post-13278 page type-page status-publish hentry">
                            <div class="entry-content">
                                <div class="vc_row wpb_row vc_row-fluid">
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="norebro-heading-sc heading text-left"
                                                     id="norebro-custom-5e838c5f2b012">
                                    ...
                                    <div
                                        class="wpb_column vc_column_container vc_col-sm-9 vc_col-lg-offset-0 vc_col-lg-6 vc_col-md-offset-0 vc_col-md-9 vc_col-sm-offset-0 vc_col-xs-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space  vc_hidden-xs" style="height: 80px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-text-sc " id="norebro-custom-5e838c5f2bc51">

                                                    <p>It is not surprising to see how computer-generated imagery takes
                                                        the world of interior design, building and real estate by storm.
                                                        However, only a small percentage of these images deserves to be
                                                        called realistic and that means quality.</p>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="norebro-gallery-sc gallery-wrap"
                                                     id="norebro-custom-5e838c5f2f9fc"
                                                     data-gallery="norebro-custom-5e838c5f2f9b1">
                                                    ...
                                                    <div class="vc_row" data-lazy-container="true">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="wrap">
                                                                <img class="gimg"
                                                                     src="./Spotless Agency introduces Floor Plan Visualization_files/1-1.jpg"
                                                                     alt="">
                                                                <div class="overlay">
                                ...
                                <div class="vc_row wpb_row vc_row-fluid">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-text-sc " id="norebro-custom-5e838c5f32c0c">

                                                    <p>Spotless Agency is one of a few companies that pays attention to
                                                        every detail on the image for it to reflect all the ideas
                                                        offered by the client. It is a leading architecture rendering
                                                        and floor plan visualization company that helps to transform a
                                                        sketch on the paper into a 3D tour around the home who looks
                                                        like incredibly close to reality.</p>
                                                    <p>How often it happens that people looking at the floor plan of an
                                                        apartment or house can not visualize what they will see in
                                                        reality. Most often it happens with the property that is at the
                                                        stage of construction or renovation. Floor plan visualizations
                                                        are the only right solution to see the completed project with a
                                                        perfect interior design even if this estate has not started to
                                                        be built yet.<br>
                                                        Spotless Agency has a team of qualified designers and architects
                                                        whose talent makes it possible to transform black-and-white
                                                        sketches into realistic staged photographs created on the basis
                                                        of the floor plan provided. We are happy to hear your
                                                        preferences about possible finishes, style of interior design
                                                        and furniture placing to make photos of the home to your
                                                        personal taste. Forget about impossible to visualize
                                                        constructions and standard paper floor plans – dive into the
                                                        world where every detail of your future home has already taken
                                                        its place in the high-quality photo.</p>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="vc_empty_space" style="height: 40px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                                <div class="norebro-gallery-sc gallery-wrap"
                                                     id="norebro-custom-5e838c5f3db43"
                                                     data-gallery="norebro-custom-5e838c5f3daf6">


                                                    <div class="vc_row" data-lazy-container="true">

                                                        <div
                                                            class=" vc_col-lg-6 vc_col-md-6 vc_col-sm-12 vc_col-xs-12 masonry-block grid-item gallery-image"
                                                            data-gallery-item="0" data-lazy-item="true">
                                                            <div class="wrap">
                                                                <img class="gimg"
                                                                     src="./Spotless Agency introduces Floor Plan Visualization_files/01.jpg"
                                                                     alt="">
                                                                <div class="overlay">
                                                                    <div class="content-center text-center">
                                                                        <div class="wrap">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="wrap">
                                                                <img class="gimg"
                                                                     src="./Spotless Agency introduces Floor Plan Visualization_files/02.jpg"
                                                                     alt="">
                                                                <div class="overlay">
                                                                    <div class="content-center text-center">
                                                                        <div class="wrap">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="wrap">
                                                                <img class="gimg"
                                                                     src="./Spotless Agency introduces Floor Plan Visualization_files/03.jpg"
                                                                     alt="">
                                                                <div class="overlay">
                                                                    <div class="content-center text-center">
                                                                        <div class="wrap">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="wrap">
                                                                <img class="gimg"
                                                                     src="./Spotless Agency introduces Floor Plan Visualization_files/04.jpg"
                                                                     alt="">
                                                                <div class="overlay">
                                                                    <div class="content-center text-center">
                                                                        <div class="wrap">
                                ...
                                <div class="vc_row wpb_row vc_row-fluid">
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-3 vc_col-md-3">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-heading-sc heading text-left"
                                                     id="norebro-custom-5e838c5f3f4dc">
                                                ...
                                                <ul class="norebro-list-box-sc list-box  with-icon"
                                                    id="norebro-custom-5e838c5f3fb37">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-9 vc_col-md-9">
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="norebro-heading-sc heading text-left"
                                                     id="norebro-custom-5e838c5f4112a">
                                                ...
                                                <div class="norebro-contact-from-sc contact-form  text-left"
                                                     id="norebro-custom-5e838c5f41602">

                                                    <div role="form" class="wpcf7" id="wpcf7-f14796-p13278-o7"
                                                         lang="ru-RU" dir="ltr">
                                                        <div class="screen-reader-response"></div>
                                                        <form
                                                            action="https://www.spotlessagency.com/flor-plan-visualization/#wpcf7-f14796-p13278-o7"
                                                                ...
                                                                <div class="wpcf7-form-control-wrap">
                                                                    <div
                                                                        ...
                                                                        <div style="width: 304px; height: 78px;">
                                                                            <div>
                                                                                <iframe
                                                                                    src="./Spotless Agency introduces Floor Plan Visualization_files/anchor.html"
                                                                                    width="304" height="78"
                                                                                    role="presentation"
                                                                                    name="a-s0ch29cfqtj6"
				...
				<textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response"
                          style="width: 250px; height: 40px; border: 1px solid #c1c1c1; margin: 10px 25px; padding: 0px; resize: none;">
                                                            ...
                                                            <p>
                                                                <button
                                                                    class="btn  brand-bg-color-hover-i brand-border-color-hover-i btn-squared btn-outline btn-brand brand-color">
                            ...
                            <ul class="recent-posts-list">
                                    ...
                                    <a href="https://www.spotlessagency.com/blog/real-estate-business-in-pandemic/"
                                       class="more">
                                        <img width="150" height="150"
                                             src="./Spotless Agency introduces Floor Plan Visualization_files/Pandemic-150x150.jpg"
                                ...
                                <li class="post-item clearfix ">
                                    ...
                                    <a href="https://www.spotlessagency.com/blog/top-12-secrets-of-the-real-estate-industry/"
                                       class="more">
                                        <img width="150" height="150"
                                             src="./Spotless Agency introduces Floor Plan Visualization_files/Untitled-new-1-150x150.jpg"
                                             class="attachment-thumbnail size-thumbnail wp-post-image" alt=""
...
<div id="pum-15168" class="pum pum-overlay pum-theme-15148 pum-theme-lightbox popmake-overlay click_open"
    ...
    <div id="popmake-15168"
         class="pum-container popmake theme-15148 pum-responsive pum-responsive-normal responsive size-normal">


        <div class="pum-content popmake-content">
            <div role="form" class="wpcf7" id="wpcf7-f15164-o8" lang="ru-RU" dir="ltr">
                <div class="screen-reader-response"></div>
                <form action="https://www.spotlessagency.com/flor-plan-visualization/#wpcf7-f15164-o8" method="post"
                    ...
                    <div class="input-group input-group-padding">
                        <label class="col-4"><span class="wpcf7-form-control-wrap menu-750"><select name="menu-750"
                                        ...
                                        value="How did you hear about us?">How did you hear about us?</option><option
                                        value="Google Search">Google Search</option><option
                                        value="Facebook">Facebook</option><option value="Instagram">Instagram</option><option
                                        value="Twitter">Twitter</option><option value="Linkedin">Linkedin</option><option
                                        value="Online Ads">Online Ads</option><option value="From a friend/colleague">From a friend/colleague</option><option
                                        value="Other">Other</option></select></span></label><br>
                        ...
                        <label class="col-4"><span class="wpcf7-form-control-wrap menu-674"><select name="menu-674"
                                        ...
                                        value="Standard">Standard</option><option value="Professional"
                                                                                  selected="selected">Professional</option></select></span></label>
                    </div>
                    <div class="input-group input-group-padding">
                        ...
                        <div class="wpcf7-form-control-wrap">
                            <div data-sitekey="6LdjjX0UAAAAAMJ2--uvuuocEyZBNKm219XpDn6o"
                                ...
                                <div style="width: 304px; height: 78px;">
                                    <div>
                                        <iframe
                                            src="./Spotless Agency introduces Floor Plan Visualization_files/anchor(1).html"
                                            width="304" height="78" role="presentation" name="a-no4zq9ufu4ez"
                                            frameborder="0" scrolling="no"
                                            sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe>
                                    </div>
    ...
    <div id="popmake-15166"
        ...
        <div class="pum-content popmake-content">
            <div role="form" class="wpcf7" id="wpcf7-f15163-o9" lang="ru-RU" dir="ltr">
                <div class="screen-reader-response"></div>
                <form action="https://www.spotlessagency.com/flor-plan-visualization/#wpcf7-f15163-o9" method="post"
                      class="wpcf7-form" novalidate="novalidate"><input type="hidden" name="pum_form_popup_id"
                                                                        value="15166">
                    <div style="display: none;">
                    ...
                    <div class="input-group input-group-padding">
                        ...
                        <label class="col-4"><span class="wpcf7-form-control-wrap menu-674"><select name="menu-674"
                                                                                                    ...
                                                                                                    disabled="disabled"><option
                                        value="Pricing">Pricing</option><option value="Light">Light</option><option
                                        value="Standard" selected="selected">Standard</option><option
                        ...
                        <div class="wpcf7-form-control-wrap">
                            <div data-sitekey="6LdjjX0UAAAAAMJ2--uvuuocEyZBNKm219XpDn6o"
                                ...
                                <div style="width: 304px; height: 78px;">
                                    <div>
                                        <iframe
                                            src="./Spotless Agency introduces Floor Plan Visualization_files/anchor(2).html"
                                            width="304" height="78" role="presentation" name="a-vzk6gj61in95"
                                            frameborder="0" scrolling="no"
                                            sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe>
                                    </div>
    ...
    <div id="popmake-15153"
        ...
        <div class="pum-content popmake-content">
            <div role="form" class="wpcf7" id="wpcf7-f15146-o10" lang="ru-RU" dir="ltr">
                <div class="screen-reader-response"></div>
                <form action="https://www.spotlessagency.com/flor-plan-visualization/#wpcf7-f15146-o10" method="post"
                      class="wpcf7-form" novalidate="novalidate"><input type="hidden" name="pum_form_popup_id"
                                                                        value="15153">
                    <div style="display: none;">
                    ...
                    <div class="input-group input-group-padding">
                        ...
                        <label class="col-4"><span class="wpcf7-form-control-wrap menu-234"><select name="menu-234"
                                                                                                    ...
                                                                                                    aria-invalid="false"
                                                                                                    disabled="disabled"><option
                                        value="Pricing">Pricing</option><option value="Light"
                                                                                selected="selected">Light</option><option
                        ...
                        <div class="wpcf7-form-control-wrap">
                            <div data-sitekey="6LdjjX0UAAAAAMJ2--uvuuocEyZBNKm219XpDn6o"
                                ...
                                <div style="width: 304px; height: 78px;">
                                    <div>
                                        <iframe
                                            src="./Spotless Agency introduces Floor Plan Visualization_files/anchor(3).html"
                                            width="304" height="78" role="presentation" name="a-ucabrd42u9i7"
                                            frameborder="0" scrolling="no"
                                            sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe>
                                    </div>
                                ...
                                <iframe style="display: none;"
                                        src="./Spotless Agency introduces Floor Plan Visualization_files/saved_resource(4).html"></iframe>
                            </div>
                            <noscript>
                                <div style="width: 302px; height: 422px;">
                                    <div style="width: 302px; height: 422px; position: relative;">
...
<link rel="stylesheet" id="aos-css" href="./Spotless Agency introduces Floor Plan Visualization_files/aos.css"
      type="text/css" media="all">
<link rel="stylesheet" id="ionicons-css"
      href="./Spotless Agency introduces Floor Plan Visualization_files/ionicons.min.css" type="text/css" media="all">
<link rel="stylesheet" id="font-awesome-css"
      href="./Spotless Agency introduces Floor Plan Visualization_files/font-awesome.min.css" type="text/css"
      media="all">
<style id="shortcodes-settings-inline-css" type="text/css">
    #norebro-custom-5e838c5f2b012 h3 {
        color: #404044;
        font-size: 34px;
    }

    #norebro-custom-5e838c5f2bc51, #norebro-custom-5e838c5f2bc51 > * {
        font-size: 16px;
    }

    #norebro-custom-5e838c5f2f9fc .gallery-image {
        padding: 15px;
    }

    #norebro-custom-5e838c5f32c0c, #norebro-custom-5e838c5f32c0c > * {
        font-size: 16px;
    }

    #norebro-custom-5e838c5f3db43 .gallery-image {
        padding: 15px;
    }

    #norebro-custom-5e838c5f3f4dc h3 {
        color: #404044;
        font-size: 28px;
        font-weight: 500;
    }

    #norebro-custom-5e838c5f3fb37 li h4 {
        line-height: 20px;
    }

    #norebro-custom-5e838c5f3fb37 li .icon {
        color: #f3b435;
    }

    #norebro-custom-5e838c5f4112a h3 {
        color: #404044;
        font-size: 28px;
        font-weight: 500;
    }

    #norebro-custom-5e838c5f41602 input:not([type='submit']), #norebro-custom-5e838c5f41602 textarea, #norebro-custom-5e838c5f41602 select {
        border-color: #dee2e7;
        color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 input::-webkit-input-placeholder, #norebro-custom-5e838c5f41602 textarea::-webkit-input-placeholder {
        color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 input::-moz-input-placeholder, #norebro-custom-5e838c5f41602 textarea::-moz-input-placeholder {
        color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 input::-ms-input-placeholder, #norebro-custom-5e838c5f41602 textarea::-ms-input-placeholder {
        color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 input::-moz-placeholder, #norebro-custom-5e838c5f41602 textarea::-moz-placeholder {
        color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 input:focus, #norebro-custom-5e838c5f41602 .focus.active, #norebro-custom-5e838c5f41602 textarea:focus {
        border-color: #5e646a;
    }

    #norebro-custom-5e838c5f41602 button.btn:hover {
        color: #ffffff !important;
    }

    #norebro-custom-5e838c5f41602 label {
        padding-top: 10px;
        padding-right: 10px;
    }
</style>
...
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/scripts.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/scripts.js(1).Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/api.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/woocommerce-hack.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/core.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/position.min.js.Без названия"></script>
<script type="text/javascript">
    /* <![CDATA[ */
    var pum_vars = {
        "version": "1.7.29",
...
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/site.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/wp-embed.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/js_composer_front.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/imagesloaded.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/masonry.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/jquery.masonry.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/underscore.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/aos.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/isotope.pkgd.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/jquery.mega-menu.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/navigation.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/skip-link-focus-fix.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/owl.carousel.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/scroll-smooth.min.js.Без названия"></script>
<script type="text/javascript"
        src="./Spotless Agency introduces Floor Plan Visualization_files/main.js.Без названия"></script>
...
<iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame"
        src="./Spotless Agency introduces Floor Plan Visualization_files/box-469cf41adb11dc78be68c1ae7f9457a4.html"
...
<div
    ...
    <div style="z-index: 2000000000; position: relative;">
        <iframe title="проверка recaptcha" src="./Spotless Agency introduces Floor Plan Visualization_files/bframe.html"
                name="c-s0ch29cfqtj6" frameborder="0" scrolling="no"
...
<div
    ...
    <div style="z-index: 2000000000; position: relative;">
        <iframe title="проверка recaptcha"
                src="./Spotless Agency introduces Floor Plan Visualization_files/bframe(1).html" name="c-no4zq9ufu4ez"
                frameborder="0" scrolling="no"
                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"
                style="width: 100%; height: 100%;"></iframe>
    </div>
...
<div
    ...
    <div style="z-index: 2000000000; position: relative;">
        <iframe title="проверка recaptcha"
                src="./Spotless Agency introduces Floor Plan Visualization_files/bframe(2).html" name="c-ucabrd42u9i7"
                frameborder="0" scrolling="no"
                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"
                style="width: 100%; height: 100%;"></iframe>
    </div>
...
<div
    ...
    <div style="z-index: 2000000000; position: relative;">
        <iframe title="проверка recaptcha"
                src="./Spotless Agency introduces Floor Plan Visualization_files/bframe(3).html" name="c-vzk6gj61in95"
                frameborder="0" scrolling="no"
                sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"
                style="width: 100%; height: 100%;"></iframe>
    </div>
</div>
<div class="norebro-gallery-opened-sc gallery" id="norebro-custom-5e838c5f2f9b1"
...
<div class="norebro-gallery-opened-sc gallery" id="norebro-custom-5e838c5f3daf6"
     data-options="{&quot;navClass&quot;:&quot;&quot;}">
